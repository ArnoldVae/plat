        ...
        <Row type="flex" class="row-bg" justify="center">
            ...
            <Col :span="14">
                ...
                <div class="square" v-for="(value,index) in this.implement.imgs" :key="index">
                    <img style="height: 100%;width: 100%" :src="value.data.vcFileFullName"
                         alt="">
                </div>
            </Col>
        </Row>
    ...
    export default {
        ...
        methods: {
            async getFindPlanRecord(val) {
                ...
                let bIndex2 = b.record.iBeginTime.substring(b.record.iBeginTime.indexOf('-')+1,b.record.iBeginTime.length)
