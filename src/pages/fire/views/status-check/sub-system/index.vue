                ...
                <div class="sub-system-top">
                    ...
                    <div class="sub-system-top-item right">
                        ...
                        <div class="item-list" style="    margin-left: 60px;">
                            <div :span="8" v-for="(i ,index) in resultData.list " :key="index">
                                <div
                                         ...
                                         <span @click="showSubItem(item)">
                                            <span class="color-green" v-show="item.areaList.length==0">●</span>
                                             <span class="color-green"
                                                   v-show="!item.showSubFlag&&item.areaList.length!=0"><i
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //获取流程图接口
            async getHtMap(item) {
                this.getId = item && item.UnitID ? item.UnitID : ''
            ...
            async getLightItem(item) {
                ...
                if (result.success) {   // result.data.list.forEach((item) => {
            ...
            async getSubMenu(item) {
                this.getId = this.$store.getters.unitId || '8177a787a28b4f86a103fac9a023db05'
