<template>
	<div id="control">
		...
		<div>
			<img src="../../assets/img/title.png" alt="" />
			<span>消防集中监控</span>
			<cvideo class="video" style="height: 93.5%!important;" :videoConfig="video2"></cvideo>
		</div>
		<div>
			<img src="../../assets/img/title.png" alt="" />
			<p></p>
			...
			<!--            <fire></fire>-->
			<iframe
				src="http://26.47.189.184:8087/#/main"
				id="myFrame"
				align="centet"
				scrolling="auto"
				...
				height="100%"
				width="3774PX"
				style="position: relative;left: 13px;width: 99%"
			></iframe>
...
import fire from '@fire/views/main-check'
