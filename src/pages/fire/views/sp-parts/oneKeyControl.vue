	...
	<div id="buttonControl">
		<div>
			...
			<cvideo
				class="video"
				:videoConfig="video2"
				style="height: 93.5%!important;width: 3630PX!important;"
			></cvideo>
		</div>
		<div>
			<img src="../../assets/img/title.png" alt="" />
			<span>主设备监视</span>
			<cvideo class="video" :videoConfig="video1" style="height: 93.5%!important;"></cvideo>
		</div>
		<div>
			<img src="../../assets/img/title.png" alt="" />
			<span>网络安全</span>
...
#buttonControl span:first-child {
	left: 60px;
}
...
#buttonControl > div:first-child {
	width: 3640px;
}

#buttonControl > div:last-child {
	position: relative;
	left: -1px;
	/*width: 3773PX;*/
	margin-right: 0;
