    ...
    instance.notice({
        ...
        content: `
            <iframe
                ...
                marginheight="0"
                marginwidth="0"
                style="position: absolute; visibility: inherit; top: -1px; left: -1px; width: calc(100% + 3px); height: calc(100% + 2px); borderRadius: 5px; z-index: 999999; filter: Alpha(opacity = 0);"
            ></iframe>
