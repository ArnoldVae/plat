(function () {
    /*zhuanzhiwu 自己研究百度离线地图
    * 搜索关键字 zhuanzhiwu 即可查看修改的地方 
    * 感谢 于忠达博客 提供的方法  https://my.oschina.net/smzd/blog/530105
    ...
    */
    ...
    z.XX = {
        ...
        main_domain_cdn: {
            baidu: ["api0.map.bdimg.com", "api1.map.bdimg.com", "api2.map.bdimg.com"],  //zpc
    ...
    z.ma = mapconfig.home; /*zhuanzhiwu 改成离线的路径 */
    ...
    "2" !== z.ou && (function (a, b, c) {
        ...
        (function (a, b, c) {
            ...
            l && (l.an && i() < l.an) && (c.alog("cus.on", "time", function (a) {
                ...
                // ky: "http://" + location.hostname + location.port + "/images/st.gif",
                page: g,
                p: "18"
            }))
        })(a, b, c)
    ...
    function Qb(a, b) {
        if (/^http/.test(a)) return; /*zhuanzhiwu 这里判断一下，如果是调用外部资源就退出去好了 */
        if (b) {
            ...
            if (d.Bd == this.Fj.Zp) c && b();
                ...
                if (d.Bd == this.Fj.nG) {
                    ...
                    e.DC == q && (e.DC = o, setTimeout(function () {
                        ...
                        /*zhuanzw 加载本地模块文件，在 modules 目录下 */
                        if (a.length > 0) {
        ...
        Nt: function (a) {
            ...
            if (!this.map.Ub() && (a ? this.map.K.s_ = a : a = this.map.K.s_, a)) for (var c = p, c = "2" == z.ou ? [z.url.proto + z.url.domain.main_domain_cdn.other[0] + "/"] : [z.url.proto + z.url.domain.main_domain_cdn.baidu[0] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[1] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[2] + "/"], d = 0, e; e = this.Km[d]; d++) if (e.f_ == o) {
                ...
                e.getTilesUrl = function (b, d) {
                    ...
                    return tdir + "/" + d + "/" + e + "/" + k + mapconfig.img_format; /*zpc 使用本地的瓦片 */
                    ...
                    //console.log(l);
                    //console.log(c[Math.abs(e + k) % c.length] + l);
    ...
    Vc.getTilesUrl = function (a, b, c) {
        ...
        e = 1;
        tdir = mapconfig.tiles_dir.length > 0 ? mapconfig.tiles_dir : mapconfig.home + "tiles";
        return tdir + "/" + b + "/" + d + "/" + a + mapconfig.img_format; /*zhuanzhiwu 使用本地的瓦片 */
        /*
              c = Uc[c];
          this.map.dE() && (e = 2);
